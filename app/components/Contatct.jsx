...
const Contatct = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "74ab3de0-0a8f-40e0-affb-ef5d475173ee");
  ...
  return (
    ...
    <motion.div
      ...
      id='contact' className='w-full px-[12%] p-10 scroll-mt-20 bg-[url{"footer-bg-color.png"}] bg-no-repeat bg-center bg[lenght:90_auto] dark:bg-none'>
      ...
      <motion.form
        ...
        <motion.textarea
          ...
          className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 resize-none dark:bg-darkHover/30 dark:border-white/90' name='message'></motion.textarea>
        <motion.button
